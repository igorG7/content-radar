...
REVOKE ALL ON ALL TABLES IN SCHEMA public FROM radar_app;--> statement-breakpoint
REVOKE ALL ON ALL SEQUENCES IN SCHEMA public FROM radar_app;--> statement-breakpoint
...
ALTER DEFAULT PRIVILEGES IN SCHEMA public REVOKE ALL ON TABLES FROM radar_app;--> statement-breakpoint
ALTER DEFAULT PRIVILEGES IN SCHEMA public REVOKE ALL ON SEQUENCES FROM radar_app;--> statement-breakpoint
